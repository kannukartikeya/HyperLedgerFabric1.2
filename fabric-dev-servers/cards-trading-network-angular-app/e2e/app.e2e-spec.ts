...
describe('Starting tests for cards-trading-network-angular-app', function() {
  ...
  it('website title should be cards-trading-network-angular-app', () => {
    page.navigateTo('/');
    return browser.getTitle().then((result)=>{
      expect(result).toBe('cards-trading-network-angular-app');
    })
  });
  ...
  it('navbar-brand should be cards-trading-network-angular-app',() => {
    element(by.css('.navbar-brand')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('cards-trading-network-angular-app');
    });
  });
